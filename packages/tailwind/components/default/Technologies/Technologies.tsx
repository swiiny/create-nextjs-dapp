...
const Technologies: FC<ITechnologies> = () => {
	return (
		<div className='flex flex-wrap justify-center items-center gap-7 md:gap-10 lg:gap-12'>
			{LOGOS.map((logo) => (
				<div
					className={`relative rounded-[12px] transition-all relative before:absolute before:-top-4 before:-left-5 before:-right-5 before:-bottom-4 before:z-[-1] before:rounded before:transition before:bg-${EColor.black} hover:opacity-100 hover:transform hover:scale-[1.05]`}
					key={logo.label}
				>
